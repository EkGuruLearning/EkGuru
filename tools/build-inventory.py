...
def build():
    ...
    gate = {
        ...
        "multilingual_audits": "AF/BD/BT/IN/IR/LK/MV/NP/PK in batch 1; NG + ID + PG + PH + ZA + CN + RU audits done (research/); TR audit done; smaller multilinguals (MY/TH/VN/IR/...) as needed",
