...
def build():
    ...
    gate = {
        ...
        "multilingual_audits": "AF/BD/BT/IN/IR/LK/MV/NP/PK in batch 1; NG + ID + PG + PH + ZA + CN + RU audits done (research/); TR + IR audits done; smaller multilinguals (MY/TH/VN/...) as needed",
