...
items = [
    ...
    ("SEO scale test with real numbers", "GREEN", "645 pages, 638 indexable, 0 duplicate titles/descs, 0 broken links, 0 orphans (1 known canonical drift /tutor.html -> /tutor/)"),
