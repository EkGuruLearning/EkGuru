...
items = [
    ...
    ("automation/generation pipeline", "GREEN", "22/22 stages PASS (run-phase7c-pipeline.py)"),
...
handoff = {
    ...
    "nextExactCommand": "python3 tools/build-lang-packs.py && python3 tools/build-phase7-pages.py && python3 tools/build-hindi-pages.py && python3 tools/test-phase7c-langs.py && python3 tools/test-phase7c-starter.py && python3 tools/test-phase7c-stage6.py",
