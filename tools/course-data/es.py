#!/usr/bin/env python3
"""Authored Spanish course data (Stage 7). Language config + content.
...
LESSONS = [
 {
  ...
  "table": [
   ...
   [
    ...
    [
     "buenos días",
     "good morning — until midday"
    ],
    [
     "buenas tardes",
     "good afternoon — midday to evening"
    ],
    [
     "buenas noches",
 ...
 },
 {
  ...
  "table": [
   ...
   [
    [
     "ser",
     "identity, origin, profession, time, permanent traits"
    ],
    [
     "estar",
     "location, mood, condition, temporary states"
    ],
    [
     "soy / estoy",
     "I am (ser / estar)"
    ...
    [
     "eres / estás",
     "you are — informal (ser / estar)"
    ],
    [
     "es / está",
     "he/she/it is (ser / estar)"
    ]
   ]
  ]
 },
