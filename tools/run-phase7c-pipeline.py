...
Stages (each runs only if the previous passed; any failure stops the run):
  ...
  2  build registries          tools/build-phase7c-registries.py
  3  build Hindi pages         tools/build-hindi-pages.py
  4  build global pages        tools/build-global-pages.py
  5  build search index        tools/build-search-index.py
  6  gate: content graph       tools/test-phase7c.py
  7  gate: conversation        tools/test-phase7c-conversation.py
  8  gate: engines/My Learning tools/test-phase7c-engines.py
  9  gate: country context     tools/test-phase7c-context.py
 10  gate: admin global ops    tools/test-phase7c-admin.py
 11  gate: multi-viewport      tools/test-phase7c-viewports.py
 12  seo scale (static crawl)  tools/test-phase7c-seo-scale.py
 13  regression: Phase 7       tools/test-phase7-browser.py
 14  regression: Phase 6       tools/test-phase6-matrix.py
 15  regression: Phase 5       tools/test-card-interactions.py
 16  reports + final gate      tools/write-phase7c-reports2.py
