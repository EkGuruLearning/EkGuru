...
WHAT THIS TOUCHES
  ...
  Then it writes the two bands the site was missing:
    ...
    .pw-support  — "every lesson here is free, and always will be", with the
...
def support_band():
    return (
        ...
        '    <p>No account, no paywall, and never an ad on the free material — that is the\n'
        '    whole idea. Keeping it that way is the only thing this page asks of you.</p>\n'
        '  </div>\n'
