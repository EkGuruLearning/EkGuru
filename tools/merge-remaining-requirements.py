...
entries.append((f, [
    ...
    S("14-16 — learn page, quiz, flashcards transitions with reduced-motion", "PARTIAL", "motion",
      "quiz/flashcard feedback exists; skeleton shimmer not yet added"),
    ...
    S("23-24 — toasts + skeletons (only for real waits)", "PARTIAL", "motion",
      "copy/booking feedback uses inline status; toast/skeleton layer is backlog"),
