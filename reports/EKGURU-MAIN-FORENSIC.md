...
The reference contains 5109 tracked files (2636 HTML). The working tree reconciles **2832 modified**, **15 added**, and **0 deleted** paths. The complete arrays are in `EKGURU-MAIN-FORENSIC.json`; the per-page result is in `EKGURU-PAGE-MATRIX.csv`.
...
- HTML: **2636** files; **1182 indexable**, **1454 noindex**.
