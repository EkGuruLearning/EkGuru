...
ekguruTutor({
  ...
  /* ===== BOOKING EMAIL — TARA ONLY ==============================
     Every booking request a student sends Tara goes to the
     ...
     press the button on Tara's row, then ask Tara to click
     ...
     If Tara would rather keep it private, get a FormSubmit alias
